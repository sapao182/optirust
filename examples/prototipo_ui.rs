/* PROTÓTIPO DE UI - VALIDADO EM 11/03/2026
   Este código serviu para validar a interface visual (cores e progresso)
   com os usuários antes da implementação do motor de compressão.
*/
